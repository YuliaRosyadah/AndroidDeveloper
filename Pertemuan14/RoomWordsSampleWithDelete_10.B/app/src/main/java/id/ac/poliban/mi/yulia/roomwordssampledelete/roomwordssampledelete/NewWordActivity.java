package id.ac.poliban.mi.yulia.roomwordssampledelete.roomwordssampledelete;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.yulia.roomwordssampledelete.REPLY";
