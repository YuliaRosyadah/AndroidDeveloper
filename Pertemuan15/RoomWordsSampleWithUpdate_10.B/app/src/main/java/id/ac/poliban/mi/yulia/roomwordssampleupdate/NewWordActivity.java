package id.ac.poliban.mi.yulia.roomwordssampleupdate;


import static id.ac.poliban.mi.yulia.roomwordssampleupdate.MainActivity.EXTRA_DATA_ID;
import static id.ac.poliban.mi.yulia.roomwordssampleupdate.MainActivity.EXTRA_DATA_UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.yulia.roomwordssampleupdate.REPLY";
    public static final String EXTRA_REPLY_ID = "id.ac.poliban.mi.yulia.roomwordssampleupdate.REPLY_ID";
